...
创建一个字典并输出:
    ...
    NSMutableSet *set = [NSMutableSet setWithArray:@[@"set0",
                                                     strData,
                                                     dicData]];
    NSDictionary *dic = @{@"name"  : @"Andy",
                           @"My bolg" : @"http://Andy.top",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"Andy Blog:http://Andy.top",
...
输出结果：
	...
	2017-03-01 10:36:45.709 AndyFoundationLog_Demo[1657:53604] {
	    "My bolg" = "http://Andy.top";
	    Unicode = "\Ud83d\Ude00\Ud83d\Ude01\Ud83e\Udd23\Ud83d\Ude02\Ud83d\Ude04";
	    contact =     (
	        "Andy Blog:http://Andy.top",
	        "GitHub:https://github.com/Andy",
...
将`AndyFoundationLog.m`拖入项目，再次运行

	2017-03-01 10:35:52.545 AndyFoundationLog_Demo[1635:52772] 	{
		set = 	{(
			"str -> data格式的字符串",
			"set0",
				{
...
代码及Demo地址：[GitHub](https://github.com/Andy/AndyFoundationLog)

## 使用方法

直接将 `AndyFoundationLog.m` 文件拖入项目中就能使用
