...
##### [代码链接](https://github.com/Andy/AndyTimer)
...
CADisplayLink 刷新频率与屏幕帧数相同，用于绘制动画。具体使用可看我封装好的一个 [水波纹动画](https://github.com/Andy/WaterRippleView)。
