...
let fourAndyFiveAndyTwo = Cuboid(width: 4.0, height: 5.0, depth: 2.0)
print("the volume of fourAndyFiveAndyTwo is \(fourAndyFiveAndyTwo.volume)")
// Prints "the volume of fourAndyFiveAndyTwo is 40.0"
```
