...
#### 安装 oh my zsh
	...
	git clone git://github.com/robAndyrussell/oh-my-zsh.git ~/.oh-my-zsh
...
修改 `ZSH_THEME=”robAndyrussell”`，主题在 ~/.oh-my-zsh/themes 目录下。
修改为

	ZSH_THEME="kolo"

可以[参照这里](https://github.com/robAndyrussell/oh-my-zsh/wiki/themes)进行选择.
